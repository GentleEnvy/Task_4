...
public final class Matrix4Factories {
    ...
    /**
     Создаёт матрицу поворота вокруг одной из осей, заданной с помощью индекса на указанный
     угол в радианах. Индексы осей: X=0, Y=1, Z=2. В случае некорректного индекса,
     возваращается единичная матрица. !!! надо кидать в этом случае exception !!!
    ...
    /**
     ...
     угол в радианах
     @param axis
     название оси, вокруг которой происходит вращение
    ...
    /**
     ...
     @param x
     X-составялющая смещения
     @param y
     Y-составляющая смещения
     @param z
     Z-составляющая смещения
    ...
    /**
     ...
     @param v
     вектор, на который производится перенос
    ...
    /**
     ...
     @param factorX
     масштабирование вдоль оси X
     @param factorY
     масштабирование вдоль оси Y
     @param factorZ
     масштабирование вдоль оси Z
    ...
    /**
     ...
     @param point
     точка схода на этой оси
     @param axisIndex
     номер оси (X=0, Y=1, Z=2)
