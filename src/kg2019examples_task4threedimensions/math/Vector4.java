...
/**
 Класс, представляющий четырёхмерный вектор для проведения матричных вчислений над
 трёхмерными точками.
...
public class Vector4 {
    ...
    /**
     ...
     @param w
     четвёртая составляющая, описывающая нормализующее значение
     */
    ...
    /**
     Создаёт экземпляр вектора на основе значений трёх составляющих. Четвёртая берётся
     равной нулю.
    ...
    /**
     Создаёт экземпляр четырёхмерного вектора на основе трёхмерного вектора и четвёртой
     составляющей W.
     
     @param v
     экземпляр трёхмерного вектора
     @param w
     четвёртая составляющая.
     */
    ...
    /**
     Создаёт экземпляр четырёхмерного вектора на основе трёхмерного вектора Четвёртая
     составляющая W принимается равной нулю.
     
     @param v
     исходный трёхмерный вектор.
     */
    ...
    /**
     Скрытый конструктор, который создаёт вектор на основе массива. Данный конструктор
     будет удобен для использования внутри класса. В связи с этим, данный конструктор
     просто сохраняет принятый массив без дополнительных обработок и проверок.
    ...
    /**
     ...
     @param number
     число, на которое умножается текущий вектор
    ...
    /**
     ...
     @param other
     вектор, с которым происходит сложение
    ...
    /**
     Возвращает нормализованный по W четырёхмерный вектор. Если W равен 0, то возвращается
     копия исходного вектора. Если W не равен 1, то возвращается новй вектор, составляющие
     которого разделены на W.
    ...
    /**
     Создаёт трёхмерный вектор, X, Y и Z составляющие которого равны соответствующим
     значениям нормализованного четырёхмерного вектора.
