...
/**
 Класс описывающий матрицу 4 на 4. Такие матрицы можно использовать для применения
...
public class Matrix4 {
    ...
    /**
     Создаёт экзмпляр матрицы на основе двумерного массива. В рамках данной реализации нет
     необходимых проверок на корректность входных аргументов.
    ...
    /**
     Скрытый конструктор, который создаёт экземпляр матрицы на основе одномерного массива
     без дополнительных проверок. Предполагается, что массив будет иметь правильный
     размер.
    ...
    /**
     Метод, создающий матрицу, состоящую из единриц, расположенных на главной диагонали, и
     нулей
    ...
    /**
     ...
     @param v
     вектор, на который надо умножить матрицу
     
     @return новый вектор-столбец, получившийся в результате умножения текущей матрицы на
     вектор.
     */
