...
/**
 Описывает класс камеры, который хранит матрицы преобразования мировой системы координат в
 систему координат камеры.
    ...
    implements ICamera
{
    ...
    /**
     ...
     Сначала к вектору применяется масштаб(S), далее поворот(R), потом перенос(T) и в конце
     - проекция(P). r = P * T * R * S * v
     
     @param v
     вектор, который надо перевести
