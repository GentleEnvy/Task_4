...
public class ScreenConverter {
    ...
    /**
     Метод, преобразующий реальные трёхмерные координаты в экранные. Z-составляющая при
     этом не учитывается
     
     @param v
     исходная трёхмерная точка
    ...
    /**
     Метод, преобразующий экранные координаты в трёхмерные. Z-составляющая при этом
